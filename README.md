...
2. Under **Assets**, download `StreamGuard_Setup_v2.1.5.exe`
...
# InnoSetupOutput\StreamGuard_Setup_v2.1.5.exe
```
...
| Event | Action |
|---|---|
| `git push` with a `v*.*.*` tag (e.g., `v2.1.5`) | Full build + GitHub Release created automatically |
