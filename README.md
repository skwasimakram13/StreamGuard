...
2. Under **Assets**, download `StreamGuard_Setup_v2.1.2.exe`
...
# InnoSetupOutput\StreamGuard_Setup_v2.1.2.exe
```
...
| Event | Action |
|---|---|
| `git push` with a `v*.*.*` tag (e.g., `v2.1.2`) | Full build + GitHub Release created automatically |
...
# Edit version.py: __version__ = "2.1.2"
# Edit installer.iss: AppVersion=2.1.2, OutputBaseFilename=StreamGuard_Setup_v2.1.2
